...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/broad-thunder-b189)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broad-thunder-b189
```

A live public deployment of this template is available at [https://broad-thunder-b189.templates.workers.dev](https://broad-thunder-b189.templates.workers.dev)
